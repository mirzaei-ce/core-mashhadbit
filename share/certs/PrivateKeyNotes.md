...
unlocked to sign the Mashhadbit-Qt.app bundle.
...
allowing somebody to distribute a Mashhadbit-Qt.app or mashhadbit-qt-setup.exe with a valid
...
that the mashhadbit-qt.exe file inside the installer had not been tampered with.
