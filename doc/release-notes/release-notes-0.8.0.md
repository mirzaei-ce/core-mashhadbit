Mashhadbit-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/mashhadbit/files/Mashhadbit/mashhadbit-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Mashhadbit
...
New/changed settings (command-line or mashhadbit.conf file)
--------------------------------------------------------
