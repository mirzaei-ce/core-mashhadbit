Mashhadbit version 0.5.4 is now available for download at:
http://sourceforge.net/projects/mashhadbit/files/Mashhadbit/mashhadbit-0.5.4/
...
http://gitorious.org/mashhadbit/mashhadbitd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Mashhadbit-Qt notifications under Growl 1.3.
Increase required age of Mashhadbit-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxMashhadbit properly when installing Mashhadbit-Qt over it. (Windows)
