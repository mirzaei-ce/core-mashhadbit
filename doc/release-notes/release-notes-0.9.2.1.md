Mashhadbit Core version 0.9.2.1 is now available from:

  https://mashhadbit.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 MBT to 0.01 MBT
...
- Fix "Start mashhadbit on system login"
