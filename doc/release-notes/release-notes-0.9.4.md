Mashhadbit Core version 0.9.4 is now available from:

  https://mashhadbit.org/bin/0.9.4/
...
this update is incompatible with the Mashhadbit system and could lead to consensus
forks.

Mashhadbit Core released binaries from https://mashhadbit.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~mashhadbit/+archive/ubuntu/mashhadbit
- A third-party or self-compiled Mashhadbit Core

upgrade to Mashhadbit Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
