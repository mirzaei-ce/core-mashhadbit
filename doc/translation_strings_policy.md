...
This document provides guidelines for internationalization of the Mashhadbit Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `mashhadbit_en.ts` remains unchanged.
