...
#ifndef MASHHADBIT_TEST_SCRIPTNUM10_H
#define MASHHADBIT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Mashhadbit Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // MASHHADBIT_TEST_BIGNUM_H
