...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CMashhadbitAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CMashhadbitAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CMashhadbitAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CMashhadbitAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CMashhadbitAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CMashhadbitAddress(arr[0].get_str()).Get() == demoAddress.Get());
