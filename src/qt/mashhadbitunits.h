...
#ifndef MASHHADBIT_QT_MASHHADBITUNITS_H
#define MASHHADBIT_QT_MASHHADBITUNITS_H
...
/** Mashhadbit unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class MashhadbitUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit MashhadbitUnits(QObject *parent);

    /** Mashhadbit units.
      @note Source: https://en.mashhadbit.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        MBT,
...
typedef MashhadbitUnits::Unit MashhadbitUnit;

#endif // MASHHADBIT_QT_MASHHADBITUNITS_H
