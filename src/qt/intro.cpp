...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/mashhadbit"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Mashhadbit Core"),
     ...
     * override -datadir in the mashhadbit.conf file in the default data directory
     * (to be consistent with mashhadbitd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
